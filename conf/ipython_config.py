...
#c.InteractiveShell.banner1 = "Python 3.5.3 |Anaconda custom (64-bit)| (default, Mar  6 2017, 11:58:13) \nType 'copyright', 'credits' or 'license' for more information\nIPython 6.1.0 -- An enhanced Interactive Python. Type '?' for help.\n"
...
#         highlighting: 
#  default, abap, autumn, arduino, friendly, vs, manni, borland, bw, monokai, rainbow_dash, paraiso-light, algol_nu, colorful, algol, perldoc, rrt, igor, murphy, pastie, paraiso-dark, tango, trac, lovelace, native, fruity, xcode, emacs, vim
